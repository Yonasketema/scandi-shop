...
import { gray80 } from "../style/color";
import { StyledNavLink as NavLink } from "./lib";

class Card extends Component {
  constructor(props) {
    super(props);
    this.inStock = this.props.item.inStock;
  ...
  render() {
    return (
      <NavLink to={this.inStock && `/product/${this.props.item.id}`}>
        <div
          style={{
            width: "20rem",
            fontWeight: "200",
            fontSize: "1.4rem",
            opacity: !this.inStock && ".5",
            cursor: this.inStock ? "pointer" : "default",
            padding: "1rem",
          }}
          css={css`
            & > .disc > button {
          ...
          >
            <div
              style={{
                ...
                position: "absolute",
                display: this.inStock ? "none" : "flex",
                justifyContent: "center",
                alignItems: "center",
                columnGap: "6rem",
              }}
